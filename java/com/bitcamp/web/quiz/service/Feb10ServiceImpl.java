...
public class Feb10ServiceImpl implements Feb10Service{
    ...
    @Override
    public void quickSort(int[] arr1, int start, int end) {
        int part = partition(arr1,start,end);
        if(start <part-1) quickSort(arr1,start,part-1);
        if(end > part) quickSort(arr1,start,part-1);
